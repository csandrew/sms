      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <button
            ...
            className="md:hidden flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100"
          >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden px-4 pb-4 border-t border-gray-100">
            <Link
              ...
              className="flex w-full text-left px-4 py-2 rounded-md text-gray-800 hover:bg-gray-50 items-center justify-between"
            >
              Become an Owner
              <ArrowRight className="w-5 h-5" />
            </Link>
            <a href="#how-it-works" className="block px-4 py-2 text-gray-600 hover:text-gray-900">
              How It Works
            </a>
            ...
            <Link
              href="/login"
              className="block w-full text-center px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold mt-3"
            >
              Sign In
            </Link>
          </div>
